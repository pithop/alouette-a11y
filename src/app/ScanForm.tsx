    ...
    <form onSubmit={handleSubmit} className="mx-auto flex max-w-xl flex-col gap-3">
      <div className="flex flex-col gap-3 sm:flex-row">
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="flex items-center justify-center rounded-md bg-blue-600 px-8 py-3 text-lg font-semibold text-white shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:bg-blue-400"
        >
          {isLoading ? (
            <>
